...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clawStatus.setMinimumSize(QtCore.QSize(70, 30))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.copilotStatus.setText(_translate("MainWindow", "---"))
        self.label_12.setText(_translate("MainWindow", "Pneumatics"))
        self.label_10.setText(_translate("MainWindow", "Pilot"))
        self.pilotStatus.setText(_translate("MainWindow", "---"))
        self.pneumaticsStatus.setText(_translate("MainWindow", "---"))
        ...
        self.clawStatus.setText(_translate("MainWindow", "---"))
